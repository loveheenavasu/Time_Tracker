...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('fullname','is_employee', 'is_staff','is_active','is_TeamLeader','email', 'contact', 'education', 'experience', 'City', 'password', 'description', 'department', 'address', 'designation', 'is_admin', 'date_joined','is_projectmanager', 'username')
        widgets = {
